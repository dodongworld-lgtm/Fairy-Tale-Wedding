...
export function VideoPreview({ title, progress = 0, duration = '1:02', currentTime = '0:00', children, className = '' }: VideoPreviewProps) {
  return (
    <div className={`w-full aspect-video rounded-2xl bg-dark-bg overflow-hidden relative shadow-2xl shadow-dark-bg/15 ${className}`}>
      ...
      <div className="absolute bottom-4 left-6 right-6">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-8 h-8 bg-white/15 rounded-full flex items-center justify-center cursor-pointer hover:bg-white/25 transition-all duration-300">
