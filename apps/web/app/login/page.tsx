...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-10 overflow-hidden bg-gradient-to-br from-indigo-700 via-violet-700 to-indigo-900">
        {/* Background pattern */}
        <div className="absolute inset-0 pointer-events-none">
          {/* Large blurred circles */}
          <div className="absolute -top-20 -left-20 w-96 h-96 bg-violet-500/30 rounded-full blur-3xl" />
        ...
        <div className="relative space-y-8">
          <div>
            <h2 className="text-4xl font-black text-white leading-tight mb-3">
              두 사람의 이야기를<br />
              <span className="text-indigo-200">영원히 기억하세요</span>
            </h2>
          ...
          <ul className="space-y-4">
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-indigo-300 text-xs mt-0.5">실제 사진을 동화 캐릭터로</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div>
                ...
                <p className="text-indigo-300 text-xs mt-0.5">입력 후 AI가 알아서 만들어요</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div>
                ...
                <p className="text-indigo-300 text-xs mt-0.5">영상 완성 후 결제하세요</p>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col bg-white">
        ...
        <div className="flex-1 flex items-center justify-center px-6 sm:px-10 py-8">
          <div className="w-full max-w-sm">
            <div className="mb-8">
              <h1 className="text-2xl font-black text-gray-900 mb-1">{t.login.title}</h1>
              <p className="text-sm text-gray-500">{t.login.subtitle}</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="text-sm font-semibold text-gray-700 block mb-1.5">{t.login.email}</label>
                <input
                  type="email"
                  value={email}
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <a href="#" className="text-xs text-indigo-600 hover:text-indigo-700 transition-colors duration-200 cursor-pointer">{t.login.forgotPassword}</a>
                </div>
                <input
                  type="password"
                  value={password}
              ...
              <button
                type="submit"
                className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl text-sm transition-colors duration-200 cursor-pointer mt-2"
              >
                {t.login.loginBtn}
              </button>
            </form>
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              {t.login.noAccount}{' '}
              <Link href="/signup" className="text-indigo-600 font-semibold hover:text-indigo-700 transition-colors duration-200 cursor-pointer">
                {t.login.signup}
              </Link>
            </p>
          </div>
